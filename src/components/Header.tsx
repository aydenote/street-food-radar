...
const Header = ({ searchLocation, setSearchLocation, userRole, onLogout, notifications, onStoreRegistrationStart }: HeaderProps) => {
			...
			<div className="max-w-7xl mx-auto px-4 py-4">
				<div className="flex items-center justify-between mb-4">
					...
					<div className="flex items-center space-x-3">
						...
						{onStoreRegistrationStart && (
							<Button variant="secondary" size="sm" onClick={onStoreRegistrationStart}>
								가게 등록/사장님 입장
							</Button>
						)}
					</div>
				...
				<div className="flex space-x-3">
					...
					<Button variant="outline" onClick={handleCurrentLocation} className="border-orange-500 text-orange-500 hover:bg-orange-50 px-4">
